...
export const userStatusSchema=z.object({
  statusCode:z.union([z.literal(StatusCode.ACTIVE),z.literal(StatusCode.INACTIVE)])
});
...
export const invitationCreateSchema=z.object({
  ...
  role:z.enum([Role.TEAM_MEMBER,Role.MANAGER,Role.ADMIN]).default(Role.TEAM_MEMBER)
});
